...
$packageName= 'electron.portable' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  softwareName  = 'electron.portable*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
